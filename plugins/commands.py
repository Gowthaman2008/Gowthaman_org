...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('💥 𝙽𝙴𝚆 𝙼𝙾𝚅𝙸𝙴𝚂 💥', url=f'https://t.me/{SUPPORT_CHAT}'),
            InlineKeyboardButton('⚙️ 𝙷𝙴𝙻𝙿 ⚙️', url=f"https://t.me/{temp.U_NAME}?start=help")
            ],[
            InlineKeyboardButton('🍿 𝙷𝙾𝚆 𝚃𝙾 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳 🍿', url='https://t.me/HTD_Tn_links/26')
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("💥 𝙶𝚁𝙾𝚄𝙿 💥", url="https://t.me/G_Movie_Request")
            ],[
            InlineKeyboardButton("⚙️ 𝙷𝙴𝙻𝙿 ⚙️", callback_data="help"),
            InlineKeyboardButton("💫 𝙰𝙱𝙾𝚄𝚃 💫", callback_data="about")
            ],[
            InlineKeyboardButton('⚜️ 𝙹𝙾𝙸𝙽 𝙼𝙾𝚅𝙸𝙴𝚂 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ⚜️', url='https://t.me/GM_Botzz')
            ]]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 Join Movies Channel", url=invite_link.invite_link
                )
            ]
        ]
